...
export default function AppearancePage() {
  ...
  // El botón siempre está habilitado si hay un tema y fuente seleccionados
  const hasChanges = selectedTheme && selectedFont && themes[selectedTheme] && fonts[selectedFont]
